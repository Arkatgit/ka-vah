...
public class IntermediateMultiplication extends IntermediateTerm {
    private IntermediateTerm left;
    private IntermediateTerm right;

    private static final int precedence = 20;

    public IntermediateMultiplication(IntermediateTerm left, IntermediateTerm right) {
        this.left = left;
        this.right = right;
    }
...
//     * @return A new IntermediateMultiplication with transformed operands.
//     */
//    @Override
//    public IntermediateTerm methodT() {
//        return new IntermediateMultiplication(left.methodT(), right.methodT());
//    }
    /**
     * For arithmetic operations, methodT() recursively calls methodT() on its operands.
    ...
    public IntermediateTerm methodT(boolean optimize) {
        return new IntermediateMultiplication(left.methodT(optimize), right.methodT(optimize));
    }
