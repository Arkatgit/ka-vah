...
//    }
//private Map<TVar, Type> unifyInternal(Type type1, Type type2, Map<TVar, Type> sub) {
//    AppLogger.info("DEBUG: Unifying " + type1 + " (" + type1.getClass().getSimpleName() +
//        ") with " + type2 + " (" + type2.getClass().getSimpleName() + ")");
//    AppLogger.info("DEBUG: Current substitution: " + sub);
//
//    if (type1.equals(type2)) {
//        AppLogger.info("DEBUG: Types are equal, returning current substitution");
//        return sub;
//    } else if (type1 instanceof TVar) {
//        AppLogger.info("DEBUG: First type is TVar (" + type1.getClass().getSimpleName() + "), calling unifyVariable");
//        return unifyVariable((TVar) type1, type2, sub);
//    } else if (type2 instanceof TVar) {
//        AppLogger.info("DEBUG: Second type is TVar (" + type2.getClass().getSimpleName() + "), calling unifyVariable");
//        return unifyVariable((TVar) type2, type1, sub);
//    } else if (type1 instanceof FType && type2 instanceof FType) {
//        FType ft1 = (FType) type1;
//        FType ft2 = (FType) type2;
//        AppLogger.info("DEBUG: Both types are FType, unifying: " +
//            ft1.getInput() + " (" + ft1.getInput().getClass().getSimpleName() + ") → " +
//            ft1.getOutput() + " (" + ft1.getOutput().getClass().getSimpleName() + ") vs " +
//            ft2.getInput() + " (" + ft2.getInput().getClass().getSimpleName() + ") → " +
//            ft2.getOutput() + " (" + ft2.getOutput().getClass().getSimpleName() + ")");
//
//        AppLogger.info("DEBUG: Unifying FType inputs: " +
//            ft1.getInput() + " (" + ft1.getInput().getClass().getSimpleName() + ") vs " +
//            ft2.getInput() + " (" + ft2.getInput().getClass().getSimpleName() + ")");
//        Map<TVar, Type> sub1 = unifyInternal(ft1.getInput(), ft2.getInput(), sub);
//        if (sub1 == null) {
//            AppLogger.info("DEBUG: FType input unification failed");
//            return null;
//        }
//        AppLogger.info("DEBUG: FType input unification succeeded: " + sub1);
//
//        AppLogger.info("DEBUG: Unifying FType outputs: " +
//            ft1.getOutput() + " (" + ft1.getOutput().getClass().getSimpleName() + ") vs " +
//            ft2.getOutput() + " (" + ft2.getOutput().getClass().getSimpleName() + ")");
//        Map<TVar, Type> sub2 = unifyInternal(ft1.getOutput(), ft2.getOutput(), sub1);
//        if (sub2 == null) {
//            AppLogger.info("DEBUG: FType output unification failed");
//            return null;
//        }
//        AppLogger.info("DEBUG: FType output unification succeeded: " + sub2);
//
//        return sub2;
//    } else if (type1 instanceof TApp && type2 instanceof TApp) {
//        TApp ta1 = (TApp) type1;
//        TApp ta2 = (TApp) type2;
//
//        AppLogger.info("DEBUG: Both types are TApp, unifying: " +
//            ta1.getTarget() + " (" + ta1.getTarget().getClass().getSimpleName() + ") " +
//            ta1.getArgument() + " (" + ta1.getArgument().getClass().getSimpleName() + ") vs " +
//            ta2.getTarget() + " (" + ta2.getTarget().getClass().getSimpleName() + ") " +
//            ta2.getArgument() + " (" + ta2.getArgument().getClass().getSimpleName() + ")");
//
//        AppLogger.info("DEBUG: Unifying TApp targets: " +
//            ta1.getTarget() + " (" + ta1.getTarget().getClass().getSimpleName() + ") vs " +
//            ta2.getTarget() + " (" + ta2.getTarget().getClass().getSimpleName() + ")");
//        Map<TVar, Type> sub1 = unifyInternal(ta1.getTarget(), ta2.getTarget(), sub);
//        if (sub1 == null) {
//            AppLogger.info("DEBUG: TApp target unification failed");
//            return null;
//        }
//        AppLogger.info("DEBUG: TApp target unification succeeded: " + sub1);
//
//        AppLogger.info("DEBUG: Unifying TApp arguments: " +
//            ta1.getArgument() + " (" + ta1.getArgument().getClass().getSimpleName() + ") vs " +
//            ta2.getArgument() + " (" + ta2.getArgument().getClass().getSimpleName() + ")");
//        Map<TVar, Type> sub2 = unifyInternal(ta1.getArgument(), ta2.getArgument(), sub1);
//        if (sub2 == null) {
//            AppLogger.info("DEBUG: TApp argument unification failed");
//            return null;
//        }
//        AppLogger.info("DEBUG: TApp argument unification succeeded: " + sub2);
//
//        return sub2;
...
//
//        AppLogger.info("DEBUG: AlgebraicDataType unification: " + adt1.getName() + " " + adt1.getParameters() +
//            " vs " + adt2.getName() + " " + adt2.getParameters());
//
//        // Check if the ADT names match
//        if (!adt1.getName().equals(adt2.getName())) {
//            AppLogger.info("DEBUG: ADT name mismatch: " + adt1.getName() + " != " + adt2.getName());
//            return null;
//        }
//
//        // Check if the parameter counts match
//        if (adt1.getParameters().size() != adt2.getParameters().size()) {
//            AppLogger.info("DEBUG: ADT parameter count mismatch: " + adt1.getParameters().size() + " != " + adt2.getParameters().size());
//            return null;
//        }
//
//        // Unify corresponding parameters
//        Map<TVar, Type> currentSub = sub;
//        for (int i = 0; i < adt1.getParameters().size(); i++) {
//            AppLogger.info("DEBUG: Unifying ADT parameters: " + adt1.getParameters().get(i) + " vs " + adt2.getParameters().get(i));
//            currentSub = unifyInternal(adt1.getParameters().get(i), adt2.getParameters().get(i), currentSub);
//            if (currentSub == null) {
//                AppLogger.info("DEBUG: ADT parameter unification failed");
//                return null;
//            }
//        }
//
//        AppLogger.info("DEBUG: ADT unification succeeded: " + currentSub);
//        return currentSub;
//    }
//
//
//    else {
//        AppLogger.info("DEBUG: No matching type cases, unification failed. " +
//            "Type1: " + type1.getClass().getSimpleName() + ", " +
//            "Type2: " + type2.getClass().getSimpleName());
//        return null;
//    }
//}
private Map<TVar, Type> unifyInternal(Type type1, Type type2, Map<TVar, Type> sub) {
...
//    private Map<TVar, Type> unifyVariable(TVar var, Type type, Map<TVar, Type> sub) {
//        AppLogger.info("==================================================");
//        AppLogger.info("DEBUG: unifyVariable called");
//        AppLogger.info("DEBUG: Variable: " + var + " (hash: " + var.hashCode() + ")");
//        AppLogger.info("DEBUG: Type: " + type + " (class: " + type.getClass().getSimpleName() + ")");
//        AppLogger.info("DEBUG: Current substitution: " + sub);
//        AppLogger.info("DEBUG: All constraints: " + constraints);
//
//        // Check if variable is already bound in substitution
//        if (sub.containsKey(var)) {
//            AppLogger.info("DEBUG: Variable " + var + " is already bound to " + sub.get(var));
//            AppLogger.info("DEBUG: Recursively unifying bound value with new type");
//            return unifyInternal(sub.get(var), type, sub);
//        }
//
//        // Check constraints
//        if (constraints.containsKey(var)) {
//            Type mustUnifyWith = constraints.get(var);
//            AppLogger.info("DEBUG: CONSTRAINT FOUND: " + var + " must satisfy " + mustUnifyWith);
//            AppLogger.info("DEBUG: Constraint type: " + mustUnifyWith.getClass().getSimpleName());
//
//            // Handle "any-adt" constraint
//            if (mustUnifyWith instanceof AlgebraicDataType &&
//                "any-adt".equals(((AlgebraicDataType) mustUnifyWith).getName())) {
//
//                AppLogger.info("DEBUG: Processing any-adt constraint");
//
//                // Check if type is a primitive that should be rejected
//                if (type instanceof Constant) {
//                    String typeName = ((Constant) type).getName();
//                    AppLogger.info("DEBUG: Type is Constant: " + typeName);
//
//                    if ("Int".equals(typeName) || "Bool".equals(typeName)) {
//                        AppLogger.info("DEBUG: CONSTRAINT VIOLATION - " + var + " cannot be primitive type " + typeName);
//                        AppLogger.info("DEBUG: Returning null (unification failed)");
//                        return null;
//                    } else {
//                        AppLogger.info("DEBUG: Constant " + typeName + " is allowed by any-adt constraint");
//                    }
//                } else if (type instanceof TVar) {
//                    AppLogger.info("DEBUG: Type is TVar, checking recursive constraints");
//                    // For TVar, we need to check if it has conflicting constraints
//                    if (constraints.containsKey(type)) {
//                        Type otherConstraint = constraints.get(type);
//                        AppLogger.info("DEBUG: Other variable has constraint: " + otherConstraint);
//                        // Add additional logic here if needed
//                    }
//                } else {
//                    AppLogger.info("DEBUG: Type " + type + " is allowed by any-adt constraint");
//                }
//
//                AppLogger.info("DEBUG: any-adt constraint satisfied for " + var);
//            } else {
//                // Handle other types of constraints with strict unification
//                AppLogger.info("DEBUG: Processing strict constraint unification");
//                Map<TVar, Type> constraintCheck = unifyInternal(mustUnifyWith, type, sub);
//                if (constraintCheck == null) {
//                    AppLogger.info("DEBUG: STRICT CONSTRAINT VIOLATION - " + var + " must be " + mustUnifyWith);
//                    AppLogger.info("DEBUG: But type is: " + type);
//                    return null;
//                }
//                AppLogger.info("DEBUG: Strict constraint satisfied: " + var + " ≡ " + mustUnifyWith);
//            }
//        } else {
//            AppLogger.info("DEBUG: No constraints found for " + var);
//        }
//
//        // Occurs check - prevent infinite recursive types
//        AppLogger.info("DEBUG: Performing occurs check for " + var + " in " + type);
//        if (occursCheck(var, type, sub)) {
//            AppLogger.info("DEBUG: Occurs check failed - " + var + " occurs in " + type);
//            return null;
//        }
//        AppLogger.info("DEBUG: Occurs check passed");
//
//        // Create new substitution with the binding
//        Map<TVar, Type> newSub = new HashMap<>(sub);
//        newSub.put(var, type);
//        AppLogger.info("DEBUG: Binding " + var + " to " + type);
//        AppLogger.info("DEBUG: New substitution: " + newSub);
//        AppLogger.info("DEBUG: unifyVariable completed successfully");
//        AppLogger.info("==================================================");
//
//        return newSub;
//    }
